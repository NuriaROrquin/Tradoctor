...
namespace Tradoctor.Services
{
    public class AmazonService : IAmazonService
    {
        ...
        public async Task<TextractResult> GetTextFromDocument(ImageTextrack imageTextrack)
        {
        ...
        private async Task<bool> CreateObjectS3Async(string awsAccessKey, string awsSecretKey, RegionEndpoint region, ImageTextrack imageTextrack, string uniqueId)
        {
